        ...
        <div className="lg:col-span-2 space-y-6">
          {step === 1 && (
            <div className="border rounded-lg p-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <input type="text" placeholder="Address" className="w-full px-4 py-2 border rounded-lg" />
              ...
              <button onClick={() => setStep(2)} className="w-full px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90">
          ...
          {step === 2 && (
            <div className="border rounded-lg p-6 space-y-4">
              ...
              <button onClick={() => setStep(3)} className="w-full px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90">
          ...
          {step === 3 && (
            <div className="border rounded-lg p-6 space-y-4">
              ...
              <p className="text-muted-foreground">Review your order details before completing your purchase</p>
