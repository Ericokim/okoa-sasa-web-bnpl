...
function OrdersPage() {
  const orders = [
    { id: 'ORD-001', date: '2025-10-20', total: 3200, status: 'Delivered', items: 2 },
    { id: 'ORD-002', date: '2025-10-15', total: 5400, status: 'In Transit', items: 3 },
    { id: 'ORD-003', date: '2025-10-10', total: 2100, status: 'Processing', items: 1 },
  ];
