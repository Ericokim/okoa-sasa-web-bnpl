    ...
    <>
      ...
      <div className="border-2  rounded-xl p-6 ">
        <div className="flex items-start justify-between">
          ...
          >
            <TrashIconWhite className="text-white" />
            Delete Account
          </button>
        </div>
      </div>
          ...
          <div className="bg-white rounded-2xl max-w-sm w-full p-6 text-center">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-full py-2 font-medium"
              >
                Delete
              </button>
              <button
                onClick={() => setOpen(false)}
                className="w-full border border-orange-500 text-orange-600 hover:bg-orange-50 rounded-full py-2 font-medium"
              >
                Cancel
              </button>
            </div>
