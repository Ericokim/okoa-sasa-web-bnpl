              ...
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 px-4 py-2 rounded-full hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-orange-200">
                  ...
                  <div className="hidden sm:flex flex-col items-start">
                    <p class="font-sans text-base font-medium leading-[140%] text-[#252525] flex-none order-0 flex-grow-0">
                      James
                      {/* {user?.name || 'User'} */}
                    </p>
                  </div>
              ...
              >
                ...
                <div className="flex items-center gap-3 px-2 py-3">
                  ...
                  <div className="flex flex-col">
                    <p className="font-sans text-base font-medium leading-[140%] text-[#252525] flex-none order-0 ">
                      James
                      {/* {user?.name || 'User'} */}
                    </p>
                  
                    <p className="font-sans text-sm font-normal leading-[140%] text-[#252525] flex-none order-1 ">
                      James@gmail.com
                ...
                <DropdownMenuItem asChild>
                  <Link
                    to="/orders"
                    className="flex items-center gap-2 px-2 py-2 font-sans text-md  font-medium leading-[140%] text-black flex-none order-1  hover:bg-orange-50 hover:text-orange-600 rounded-lg cursor-pointer transition-colors"
                  >
                ...
                <DropdownMenuItem
                  onClick={logout}
                  className="flex items-center gap-2 px-2 py-2 text-md  text-red-600 hover:bg-red-50 rounded-lg cursor-pointer transition-colors font-medium"
                >
